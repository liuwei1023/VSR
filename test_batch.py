...
if __name__ == "__main__":
    ...
    input_folder = "/dfsdata2/liuwei79_data/share/kesci_ai_challenger/vsr/round1/test/540P/" + system_config.extension
        ...
        for video_name in video_list:
            ...
            while(frame_index < len(frames_list)):
                ...
                for i in range(batch_size):
                    ...
                    output_path = os.path.join(output_img_folder, frames_list[cur_output_index])
