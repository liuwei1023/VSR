...
if __name__ == "__main__":
    ...
    if MODE == "VSR":
        ...
        if system_config.net == "EDVR":
            ...
            net = EDVR_arch.EDVR_CBAM_Nonlocal(128, depth, 8, 3, system_config.non_local[0], 2, 25, system_config.non_local[1], 10, system_config.non_local[2], 5, predeblur=False, HR_in=False)
        elif system_config.net == "EDVR_CBAM_Denoise_Nonlocal":
            net = EDVR_arch.EDVR_Denoise_Nonlocal(128, depth, 8, 5, 5, 3, system_config.non_local[0], 2, 25, system_config.non_local[1], 10, system_config.non_local[2], 5, predeblur=False, HR_in=False)
